...
type componentLine struct {
	tag string
	presense int
	fn func(bom_component.Component) (string, error)
}

var componentContent = []componentLine{
	{"PackageName", mandatory, func (c bom_component.Component) (string, error) { return c.Name, nil} },
	{"SPDXID", mandatory, func (c bom_component.Component) (string, error) { return "SPDXRef-Package-" + c.Name, nil } },
...
func noAssertion (c bom_component.Component) (string, error) { return "NOASSERTION", nil}
